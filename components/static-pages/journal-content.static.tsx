...
export function JournalContent() {
  return (
    <>
      ...
      <img className="w-full h-full object-cover transition-transform duration-1000" data-alt="A vertical, cinematic portrait of a traditional honey-colored limestone cottage in Snowshill during a quiet winter dusk. The house is surrounded by a light dusting of snow, and a warm, soft glow emanates from the windows. The lighting is low-key and atmospheric, capturing the 'blue hour' transition with deep shadows and soft highlights. The aesthetic is sophisticated and minimalist, reflecting a premium editorial magazine layout." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAGWV_3M7HSia5naB2eIlpagZRcrai2Zm6VCCbxNZxCo-zNJq7xgUiIi5UISZq_SKJsD7zenmHMwTefL0r2aALeErzGIQbNggkyz9DYMNcHAJegUh4tMUs9k5JdDbjDh-6Y0aBcA7toG4vP6VnB7BtJN8b3R09W2xvf23oXGKF3w-PBKuGM2vHoAyUl4n0F2FjD-Xpk1fc6tYg0BGYZlsUUR_mPyYJoSomqZxZNFtO_Omw6sePXwIJp8Z6QuZw09MNfOAf8CYKpTA" />
